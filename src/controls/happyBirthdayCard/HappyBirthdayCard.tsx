      ...
      <div className={styles.happyBirdthay}>
        <div className={styles.documentCardWrapper}>
          <div className={styles.documentCard}>
            ...
            <Label className={styles.displayBirthday}>{this.props.years + "-" + this.props.birthday}</Label>
            {/* {
              this.state.isBirthdayToday ?
                <Label className={styles.displayBirthdayToday}>{this.props.years + "-" + this.props.birthday}</Label>
                :
                <Label className={styles.displayBirthday}>{this.props.years + "-+" + this.props.birthday}</Label>
            } */}
